...
export declare class Indexer extends HttpProvider {
    ...
    newUploaderFromIndexerNodes(blockchain_rpc: string, signer: Signer, flow_contract: string, expectedReplica: number): Promise<[Uploader | null, Error | null]>;
    selectNodes(expectedReplica: number): Promise<[StorageNode[], Error | null]>;
    upload(file: AbstractFile, segIndex: number | undefined, blockchain_rpc: string, signer: Signer, flow_contract: string, opts?: UploadOption, retryOpts?: RetryOpts): Promise<[string, Error | null]>;
