...
export declare class Indexer extends HttpProvider {
    ...
    newUploaderFromIndexerNodes(blockchain_rpc: string, flow: FixedPriceFlow, segNum: number, expectedReplica: number): Promise<[Uploader | null, Error | null]>;
    selectNodes(segNum: number, expectedReplica: number): Promise<[StorageNode[], Error | null]>;
